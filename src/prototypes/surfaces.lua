...
local hexalith= 
{
    ...
    icon = "__hexalith-nuclear-science__/graphics/planet-hexalith.png",
    icon_size = 512,
    label_orientation = 0.55,
    starmap_icon = "__hexalith-nuclear-science__/graphics/planet-hexalith.png",
...
data:extend {{
    ...
    icons = PlanetsLib.technology_icon_constant_planet("__hexalith-nuclear-science__/graphics/planet-hexalith.png", 512),
    icon_size = 512,
    essential = true,
